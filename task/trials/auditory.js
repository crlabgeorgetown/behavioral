...
class AuditorySyllableToGraphemeMatchingTrial {
    constructor(config) {
        this.ItemNum = config.ItemNum
        this.TrialType = config.TrialType
    ...
    audioSource() {
        const sound = this.CRESP
        return `https://3m1l1032.github.io/behavioral/static/auditory_syllable_to_grapheme_matching_wav_files/${sound}.wav`
    }
}

export { AuditoryLetterIDTrial, AuditorySyllableToGraphemeMatchingTrial }