...
function renderInterpretationSection(doc, interpretation, currentY, pageHeight) {
    ...
    // If there's not enough space for at least the title, move to new page
...
export default class LocalClient {
    ...
    exportPdf() {
        ...
        renderInterpretationSection(doc, analysis.interpretation, cursorY, doc.internal.pageSize.getHeight())
