...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Task: () => (/* binding */ Task)\n/* harmony export */ });\n/* harmony import */ var _shared_screens_inputDevices__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../shared/screens/inputDevices */ \"./shared/screens/inputDevices.js\");\n/* harmony import */ var _screens_instructions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./screens/instructions */ \"./lexicalDecision/screens/instructions.js\");\n/* harmony import */ var _screens_auditoryTrial__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./screens/auditoryTrial */ \"./lexicalDecision/screens/auditoryTrial.js\");\n/* harmony import */ var _screens_writtenTrial__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./screens/writtenTrial */ \"./lexicalDecision/screens/writtenTrial.js\");\n/* harmony import */ var _shared_screens_participantID__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/screens/participantID */ \"./shared/screens/participantID.js\");\n/* harmony import */ var _trial__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./trial */ \"./lexicalDecision/trial.js\");\n/* harmony import */ var _shared_task__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/task */ \"./shared/task.js\");\n/* harmony import */ var _shared_components_responseButtons__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../shared/components/responseButtons */ \"./shared/components/responseButtons.js\");\n/* harmony import */ var _shared_qualtricsClient__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../shared/qualtricsClient */ \"./shared/qualtricsClient.js\");\n\n\n\n\n\n\n\n\n\n\n\nclass Task extends _shared_task__WEBPACK_IMPORTED_MODULE_6__.BaseTask {\n\tconstructor(data, engine, type) {\n        super()\n        \n        this.engine = engine\n        this.trials = []\n        this.data = data\n        this.dataIndex = 0\n        this.inTrial = false\n        this.type = type\n\n        this.initializeScreens()\n\t}\n\n    initializeScreens() {\n        _shared_components_responseButtons__WEBPACK_IMPORTED_MODULE_7__.RED_LABEL.text('Not a word')\n        _shared_components_responseButtons__WEBPACK_IMPORTED_MODULE_7__.GREEN_LABEL.text('Real word')\n\n        this.trialScreen = this.type === 'auditory' ? new _screens_auditoryTrial__WEBPACK_IMPORTED_MODULE_2__.AuditoryTrialScreen(this) : new _screens_writtenTrial__WEBPACK_IMPORTED_MODULE_3__.WrittenTrialScreen(this)\n        \n        this.instructionScreens = [\n            new _shared_screens_participantID__WEBPACK_IMPORTED_MODULE_4__.ParticipantIdScreen(this),\n            new _shared_screens_inputDevices__WEBPACK_IMPORTED_MODULE_0__.InputDevicesScreen(this), \n            new _screens_instructions__WEBPACK_IMPORTED_MODULE_1__.InstructionsOne(this), \n            new _screens_instructions__WEBPACK_IMPORTED_MODULE_1__.InstructionsTwo(this), \n            new _screens_instructions__WEBPACK_IMPORTED_MODULE_1__.InstructionsThree(this),\n            this.trialScreen\n        ]\n\n        this.setupInstructionScreens()\n    }\n\n    get currentTrial() {\n        return this.trials[this.trials.length - 1]\n    }\n\n    get currentProcedure() {\n        return this.data[this.dataIndex].Procedure\n    }\n\n    get isDone() {\n        return this.dataIndex === this.data.length - 1\n    }\n\n    newTrial() {\n        this.trials.push(new _trial__WEBPACK_IMPORTED_MODULE_5__.Trial(this.data[this.dataIndex]))        \n    }\n\n    submit() {\n        const columns = [\n            'ItemNum',\n            'Item',\n            'CRESP',\n            'TimedOut',\n            'RT',\n            'Accuracy',\n            'WordType',\n            'Frequency',\n            'Regularity',\n            'Imageability',\n            'PartofSpeech',\n            'Lexicality',\n            'Response',\n            'TrialType',\n            'Time'\n        ]\n        if (window.location.host === \"georgetown.az1.qualtrics.com\") {\n            const qualtricsClient = new _shared_qualtricsClient__WEBPACK_IMPORTED_MODULE_8__.QualtricsClient(columns, this.inputDevice, this.participantID)\n            qualtricsClient.collectTrialData(this.trials)\n            qualtricsClient.submitEmbeddedData()\n            this.engine.clickNextButton()\n        }\n    }\n}\n\n\n\n\n//# sourceURL=webpack://behavioral/./lexicalDecision/task.js?");
