...
/***/ "./shared/components/replayAudio.js":
/*!******************************************!*\
  !*** ./shared/components/replayAudio.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   REPLAY_CONTAINER: () => (/* binding */ REPLAY_CONTAINER)\n/* harmony export */ });\n/* harmony import */ var _static_images_replayAudio_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../static/images/replayAudio.png */ \"./static/images/replayAudio.png\");\n\n\n\nconst REPLAY_AUDIO = jQuery('<img/>', {id: 'replayAudio', class: 'replay-audio', src: _static_images_replayAudio_png__WEBPACK_IMPORTED_MODULE_0__})\n\nconst REPLAY_CONTAINER = jQuery('<div/>', {\n    id: 'replayContainer', \n    class: 'instruction-button-container',\n    css: {\n        paddingTop: '75px'\n    }\n})\n\nREPLAY_CONTAINER.append(REPLAY_AUDIO)\n\n\n\n//# sourceURL=webpack://behavioral/./shared/components/replayAudio.js?");
...
/***/ "./task/screens/trials/auditory.js":
/*!*****************************************!*\
  !*** ./task/screens/trials/auditory.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   AuditoryLetterIDTrialScreen: () => (/* binding */ AuditoryLetterIDTrialScreen),\n/* harmony export */   InstructionAuditoryLetterID: () => (/* binding */ InstructionAuditoryLetterID)\n/* harmony export */ });\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../base */ \"./task/screens/base.js\");\n/* harmony import */ var _shared_components_textContainer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../shared/components/textContainer */ \"./shared/components/textContainer.js\");\n/* harmony import */ var _shared_components_audioContainer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../shared/components/audioContainer */ \"./shared/components/audioContainer.js\");\n/* harmony import */ var _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared/components/letterContainer */ \"./shared/components/letterContainer.js\");\n/* harmony import */ var _shared_components_instructionButtons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../shared/components/instructionButtons */ \"./shared/components/instructionButtons.js\");\n\n\n\n\n\n\nclass AuditoryLetterIDTrialScreen extends _base__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\n    get components() {\n        return new Map([\n            [_shared_components_textContainer__WEBPACK_IMPORTED_MODULE_1__.TEXT_CONTAINER, {text: '+', addClass: 'base-text extra-large-text large-fixed-height'}],\n            [_shared_components_audioContainer__WEBPACK_IMPORTED_MODULE_2__.AUDIO_CONTAINER, {}],\n            [_shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.SIX_LETTER_CONTAINER, {addClass: 'grid-container six-letter-container'}],\n        ])\n    }\n\n    get clickHandlers() {\n        return { \n            topleft: (event) => this.proceedClickHandler(event, 'topleft'),\n            topmid: (event) => this.proceedClickHandler(event, 'topmid'),\n            topright: (event) => this.proceedClickHandler(event, 'topright'),\n            botleft: (event) => this.proceedClickHandler(event, 'botleft'),\n            botmid: (event) => this.proceedClickHandler(event, 'botmid'),\n            botright: (event) => this.proceedClickHandler(event, 'botright')\n        }\n    }\n\n    proceedClickHandler(event, location) {\n        event.stopPropagation()\n        clearTimeout(this.timeoutID)\n\n        this.orchestrator.currentTrial.responseTime = new Date()\n        this.orchestrator.currentTrial.ResponseLocation = location\n        this.orchestrator.currentTrial.Response = this.orchestrator.currentTrial.location[location]\n        const isPractice = this.orchestrator.currentTrial.TrialType === 'Practice'\n\n        if (!this.orchestrator.currentTrial.isCorrect() && isPractice) {\n            this.orchestrator.replay()\n        } else {\n            this.orchestrator.next()\n        }\n        _shared_components_textContainer__WEBPACK_IMPORTED_MODULE_1__.TEXT_CONTAINER.show()\n    }\n\n    startTrial() {\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.SIX_LETTER_CONTAINER.hide()\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.topleft.text(this.orchestrator.currentTrial.topleft)\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.topmid.text(this.orchestrator.currentTrial.topmid)\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.topright.text(this.orchestrator.currentTrial.topright)\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.botleft.text(this.orchestrator.currentTrial.botleft)\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.botmid.text(this.orchestrator.currentTrial.botmid)\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.botright.text(this.orchestrator.currentTrial.botright)\n        setTimeout(() => {\n            _shared_components_audioContainer__WEBPACK_IMPORTED_MODULE_2__.AUDIO_SOURCE.attr('src', this.orchestrator.currentTrial.audioSource())\n            _shared_components_audioContainer__WEBPACK_IMPORTED_MODULE_2__.AUDIO_CONTAINER[0].load()\n            _shared_components_textContainer__WEBPACK_IMPORTED_MODULE_1__.TEXT_CONTAINER.hide()\n            _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.SIX_LETTER_CONTAINER.show()\n            setTimeout(() => {\n                _shared_components_audioContainer__WEBPACK_IMPORTED_MODULE_2__.AUDIO_CONTAINER[0].play()\n                this.orchestrator.currentTrial.startTime = new Date()\n                this.timeoutID = setTimeout(() => {\n                    this.orchestrator.currentTrial.TimedOut = true\n                    this.orchestrator.currentTrial.responseTime = new Date()\n                    this.orchestrator.timedOut()\n                    _shared_components_textContainer__WEBPACK_IMPORTED_MODULE_1__.TEXT_CONTAINER.show()\n                }, this.orchestrator.variant.timeToTimeout)\n            }, this.orchestrator.variant.waitDuration)\n        }, this.orchestrator.variant.fixationDuration)\n    }\n}\n\nclass InstructionAuditoryLetterID extends _base__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\n    get components() {\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.topleft.text('d')\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.topmid.text('f')\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.topright.text('j')\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.botleft.text('n')\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.botmid.text('q')\n        _shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.botright.text('h')\n        return new Map([\n            [_shared_components_letterContainer__WEBPACK_IMPORTED_MODULE_3__.SIX_LETTER_CONTAINER, {addClass: 'grid-container-instruction six-letter-container'}],\n            [_shared_components_textContainer__WEBPACK_IMPORTED_MODULE_1__.TEXT_CONTAINER, {text: 'You will see six letters.\\nYou will hear a letter.\\n\\nTouch the letter that you hear.', addClass: 'base-text medium-text'}],\n            [_shared_components_instructionButtons__WEBPACK_IMPORTED_MODULE_4__.INSTRUCTION_BUTTON_CONTAINER, {}]\n        ])\n    }\n\n    get clickHandlers() {\n        return { \n            nextButton: () => this.orchestrator.next(),\n            previousButton: () => this.orchestrator.previous()\n        }\n    }\n}\n\n\n\n\n//# sourceURL=webpack://behavioral/./task/screens/trials/auditory.js?");
...
/***/ "./task/variants/auditory.js":
/*!***********************************!*\
  !*** ./task/variants/auditory.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   AuditoryLetterID: () => (/* binding */ AuditoryLetterID)\n/* harmony export */ });\n/* harmony import */ var _screens_instruction__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../screens/instruction */ \"./task/screens/instruction.js\");\n/* harmony import */ var _screens_transition__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../screens/transition */ \"./task/screens/transition.js\");\n/* harmony import */ var _trials_auditory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../trials/auditory */ \"./task/trials/auditory.js\");\n/* harmony import */ var _screens_trials_auditory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../screens/trials/auditory */ \"./task/screens/trials/auditory.js\");\n\n\n\n\n\nclass AuditoryLetterID {\n    constructor() {\n        this.screens = [\n            _screens_instruction__WEBPACK_IMPORTED_MODULE_0__.ParticipantId, \n            _screens_instruction__WEBPACK_IMPORTED_MODULE_0__.InputDevice,\n            _screens_trials_auditory__WEBPACK_IMPORTED_MODULE_3__.InstructionAuditoryLetterID,\n            _screens_transition__WEBPACK_IMPORTED_MODULE_1__.LetsPractice\n        ]\n\n        this.testNameShort = \"AuditoryLetterID\"\n        this.buildTestID = 191\n        this.ePrimeTemplateID = 62\n        this.fixationDuration = 250\n        this.timeToTimeout = 8000\n        this.waitDuration = 500\n\n        this.trialClass = _trials_auditory__WEBPACK_IMPORTED_MODULE_2__.AuditoryLetterIDTrial\n        this.trialScreenClass = _screens_trials_auditory__WEBPACK_IMPORTED_MODULE_3__.AuditoryLetterIDTrialScreen\n    }\n}\n\n\n\n\n\n//# sourceURL=webpack://behavioral/./task/variants/auditory.js?");
...
/***/ "./static/images/replayAudio.png":
/*!***************************************!*\
  !*** ./static/images/replayAudio.png ***!
  \***************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"b8d76ad31494e777431f.png\";\n\n//# sourceURL=webpack://behavioral/./static/images/replayAudio.png?");
